<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
        ...
        <ul class="navbar-nav">
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }}" href="{{ route('dashboard') }}">
                    ...
                    <span class="nav-link-text ms-1">Painel inicial</span>
                </a>
            </li>

            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Acesso</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'mystore' ? 'active' : '' }}" href="{{ route('mystore') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Lojas cadastradas</span>
                </a>
            </li>

            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'signatures' ? 'active' : '' }}" href="{{ route('signatures') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['signatures']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Assinaturas</span>
                </a>
            </li>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'settings' ? 'active' : '' }}" href="{{ route('settings') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['settings']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
    ...
    <div class="card shadow-lg " id="navbarFixed">
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <p class="text-xs font-weight-bold">Solicite um bate-papo</p>
                    <a href="https://api.whatsapp.com/send?phone=5514996159827&text=Ol%C3%A1%2C%20meu%20assunto%20%C3%A9%20sobre%20o%20linke" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Solicitar ajuda</a>
                </div>
            </div>
        </div>
    </div>
