            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        ...
                        @else
                        <img src="{{asset('storage/'.$user->avatar)}}" alt="..." class="w-100 border-radius-lg shadow-sm">
                        @endif <input wire:model="newimage" type="file" hidden style="display: none;" id="input-update-photo" accept="image/*">
    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Minhas informações') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                ...
                <div wire:model="showSuccesNotification" class="mt-3 alert alert-primary alert-dismissible fade show" role="alert">
                    ...
                    <span class="alert-text text-white">{{ __('Perfil alterado com sucesso!') }}</span>
