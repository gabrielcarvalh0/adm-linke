              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    ...
                    <p class="mb-5">Sua empresa disponível em um só link</p>
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">Olá, {{Auth::user()->name}}!  </h5>
                <p class="text-white">Agradecemos pelo registro, esperamos contribuir com seu negócio. ✨</p>
              </div>
            </div>
          </div>
        </div>
