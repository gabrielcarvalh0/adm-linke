            ...
            <div class="col-9 mx-auto">
                ...
                <div class="card card-body mt-4">
                    <form wire:submit.prevent="update({{$product->id}})" action="#" method="POST" role="form">
                        ...
                        @error('product.category') <span class="text-danger text-sm mb-0">{{ $message }}</span> @enderror
                        <select wire:model="product.category" class="form-control" id="productOption">
