                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            ...
                            @endif
                            <h4 class="mb-0">{{ __('Esqueceu sua senha? Informe seu e-mail cadastrado') }}</h4>
                        </div>
                        <div class="card-body">
                            <form wire:submit.prevent="recoverPassword" action="#" method="POST" role="form text-left">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn bg-gradient-info w-100 mt-4 mb-0">{{ __('Solicitar nova senha') }}</button>
                                </div>
                            </form>
                            @if ($showSuccesNotification)
                                <div wire:model="showSuccesNotification"
                                    ...
                                    <span
                                        class="alert-text text-white">{{ __('Um email para redefinir sua senha foi enviado!') }}</span>
                            ...
                            @if ($showFailureNotification)
                                <div wire:model="showFailureNotification"
                                    ...
                                    <span class="alert-text text-white">
                                        {{ __('Você não está registrado como um usuário. Por favor assine!') }}
