                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <p class="mb-0">{{ __('Esqueceu sua senha? Digite seu email e nova senha aqui') }}
                            <p>
                        </div>
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="resetPassword" action="#" method="POST" role="form text-left">
                                ...
                                <div>
                                    <label for="passwordConfirmation">{{ __('Confirmar senha') }}</label>
                                    <div
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn bg-gradient-info w-100 mt-4 mb-0">{{ __('Alterar senha') }}</button>
                                </div>
                            </form>
                            ...
                            @if ($showSuccesNotification)
                                <div wire:model="showSuccesNotification"
                                    ...
                                    <span class="alert-text text-white">
                                        {{ __('Sua senha foi alterada com sucesso!') }}</a></span>
                            ...
                            @if ($showFailureNotification)
                                <div wire:model="showFailureNotification"
                                    ...
                                    <span class="alert-text">{{ 'Por favor digite e-mail correto!' }}</span>
